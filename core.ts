...
import { getDefaultAgent } from 'increase/_shims/agent';
import { fetch, isPolyfilled as fetchIsPolyfilled } from 'increase/_shims/fetch';
import type { RequestInfo, RequestInit, Response } from 'increase/_shims/fetch';
import { isMultipartBody } from './uploads';
export { maybeMultipartFormRequestOptions, multipartFormRequestOptions, createForm } from './uploads';
export type { Uploadable } from 'increase/_shims/uploadable';
