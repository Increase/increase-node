...
export class Entities extends APIResource {
  ...
  list(query: EntityListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<EntitiesPage>{
...
export namespace Entity {export interface Corporation  {
  /**
...
export namespace Corporation {export interface Address  {
  /**
...
export namespace BeneficialOwners {export interface Individual  {
  /**
...
export namespace Individual {export interface Address  {
  /**
 * The city of the address.
 */
city: string
...
export namespace NaturalPerson {export interface Address  {
  /**
 * The city of the address.
 */
city: string
...
export namespace Joint {export interface Individuals  {
  /**
 * The person's address.
 */
...
export namespace Individuals {export interface Address  {
  /**
 * The city of the address.
 */
city: string
...
export namespace Trust {export interface Address  {
  /**
 * The city of the address.
 */
city: string
...
export namespace Trustees {export interface Individual  {
  /**
 * The person's address.
 */
address: Individual.Address
...
export namespace Grantor {export interface Address  {
  /**
 * The city of the address.
 */
city: string
...
export namespace EntityCreateParams {export interface Corporation  {
  /**
 * The corporation's address.
 */
address: Corporation.Address
...
export namespace Identification {export interface Passport  {
  /**
