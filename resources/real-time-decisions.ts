...
export class RealTimeDecisions extends APIResource {
  ...
  retrieve(realTimeDecisionId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<RealTimeDecision>>{
         return this.get(`/real_time_decisions/${realTimeDecisionId}`, options)
       };

  action(realTimeDecisionId: string, body: RealTimeDecisionActionParams, options?: Core.RequestOptions): Promise<Core.APIResponse<RealTimeDecision>>{
 ...
 */
category: 'card_authorization_requested' | 'digital_wallet_token_requested' | 'digital_wallet_authentication_requested'
...
export namespace RealTimeDecision {export interface CardAuthorization  {
  /**
...
export namespace RealTimeDecisionActionParams {export interface CardAuthorization  {
  /**
...
export namespace DigitalWalletToken {export interface Approval  {
  /**
