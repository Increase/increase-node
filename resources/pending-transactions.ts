...
export class PendingTransactions extends APIResource {
  ...
  retrieve(pendingTransactionId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<PendingTransaction>>{
         return this.get(`/pending_transactions/${pendingTransactionId}`, options)
       };

  list(query?: PendingTransactionListParams, options?: Core.RequestOptions): Core.PagePromise<PendingTransactionsPage>;
  list(options?: Core.RequestOptions): Core.PagePromise<PendingTransactionsPage>;
  list(query: PendingTransactionListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<PendingTransactionsPage>{
...
export namespace PendingTransactionListParams {export interface Status  {
  /**
