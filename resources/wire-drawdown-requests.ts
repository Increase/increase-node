...
export class WireDrawdownRequests extends APIResource {
  ...
  create(body: WireDrawdownRequestCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<WireDrawdownRequest>>{
         return this.post('/wire_drawdown_requests', { body, ...options })
       };

  retrieve(wireDrawdownRequestId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<WireDrawdownRequest>>{
         return this.get(`/wire_drawdown_requests/${wireDrawdownRequestId}`, options)
       };

  list(query?: WireDrawdownRequestListParams, options?: Core.RequestOptions): Core.PagePromise<WireDrawdownRequestsPage>;
  list(options?: Core.RequestOptions): Core.PagePromise<WireDrawdownRequestsPage>;
  list(query: WireDrawdownRequestListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<WireDrawdownRequestsPage>{
...
export namespace WireDrawdownRequest {export interface Submission  {
  /**
