...
export class ExternalAccounts extends APIResource {
  ...
  create(body: ExternalAccountCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<ExternalAccount>>{
         return this.post('/external_accounts', { body, ...options })
       };

  retrieve(externalAccountId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<ExternalAccount>>{
         return this.get(`/external_accounts/${externalAccountId}`, options)
       };

  update(externalAccountId: string, body: ExternalAccountUpdateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<ExternalAccount>>{
         return this.patch(`/external_accounts/${externalAccountId}`, { body, ...options })
       };

  list(query?: ExternalAccountListParams, options?: Core.RequestOptions): Core.PagePromise<ExternalAccountsPage>;
  list(options?: Core.RequestOptions): Core.PagePromise<ExternalAccountsPage>;
  list(query: ExternalAccountListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<ExternalAccountsPage>{
