...
export class Limits extends APIResource {
  ...
  update(limitId: string, body: LimitUpdateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Limit>>{
  ...
  list(query: LimitListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<LimitsPage>{
