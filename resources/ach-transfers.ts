...
export class ACHTransfers extends APIResource {
  ...
  create(body: ACHTransferCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<ACHTransfer>>{
  ...
  list(query: ACHTransferListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<ACHTransfersPage>{
...
export namespace ACHTransferListParams {export interface CreatedAt  {
  /**
