...
export class ACHPrenotifications extends APIResource {
  ...
  create(body: ACHPrenotificationCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<ACHPrenotification>>{
         return this.post('/ach_prenotifications', { body, ...options })
       };

  retrieve(achPrenotificationId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<ACHPrenotification>>{
         return this.get(`/ach_prenotifications/${achPrenotificationId}`, options)
       };

  list(query?: ACHPrenotificationListParams, options?: Core.RequestOptions): Core.PagePromise<ACHPrenotificationsPage>;
  list(options?: Core.RequestOptions): Core.PagePromise<ACHPrenotificationsPage>;
  list(query: ACHPrenotificationListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<ACHPrenotificationsPage>{
...
export namespace ACHPrenotification {export interface PrenotificationReturn  {
  /**
 * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time at which
...
export namespace ACHPrenotificationListParams {export interface CreatedAt  {
  /**
