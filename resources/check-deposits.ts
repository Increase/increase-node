...
export class CheckDeposits extends APIResource {
  ...
  create(body: CheckDepositCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<CheckDeposit>>{
  ...
  list(query: CheckDepositListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<CheckDepositsPage>{
...
export namespace CheckDepositListParams {export interface CreatedAt  {
  /**
