...
export class AccountNumbers extends APIResource {
  ...
  create(body: AccountNumberCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<AccountNumber>>{
  ...
  update(accountNumberId: string, body: AccountNumberUpdateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<AccountNumber>>{
  ...
  list(query: AccountNumberListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<AccountNumbersPage>{
