...
export class WireTransfers extends APIResource {
  ...
  create(body: WireTransferCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<WireTransfer>>{
  ...
  list(query: WireTransferListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<WireTransfersPage>{
 ...
 */
status: 'canceled' | 'requires_attention' | 'pending_approval' | 'rejected' | 'reversed' | 'complete' | 'pending_creating'
...
export namespace WireTransfer {export interface Approval  {
  /**
 * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time at which
...
export namespace WireTransferListParams {export interface CreatedAt  {
  /**
