...
export class Files extends APIResource {
  ...
  list(query: FileListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<FilesPage>{
 ...
 * gracefully.
 */
purpose: 'check_image_front' | 'check_image_back' | 'form_1099_int' | 'form_ss_4' | 'identity_document' | 'increase_statement' | 'other' | 'trust_formation_document' | 'digital_wallet_artwork' | 'digital_wallet_app_icon' | 'entity_supplemental_document'
 ...
 */
purpose: 'check_image_front' | 'check_image_back' | 'form_ss_4' | 'identity_document' | 'other' | 'trust_formation_document' | 'digital_wallet_artwork' | 'digital_wallet_app_icon' | 'entity_supplemental_document'
...
export namespace FileListParams {export interface CreatedAt  {
  /**
 ...
 */
in?: Array<'check_image_front' | 'check_image_back' | 'form_1099_int' | 'form_ss_4' | 'identity_document' | 'increase_statement' | 'other' | 'trust_formation_document' | 'digital_wallet_artwork' | 'digital_wallet_app_icon' | 'entity_supplemental_document'>
}}