...
export class Cards extends APIResource {
  ...
  update(cardId: string, body: CardUpdateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Card>>{
  ...
  list(query: CardListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<CardsPage>{
  ...
  retrieveSensitiveDetails(cardId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<CardDetails>>{
...
export namespace Card {export interface BillingAddress  {
  /**
...
export namespace CardCreateParams {export interface BillingAddress  {
  /**
 * The city of the billing address.
 */
city: string
...
export namespace CardUpdateParams {export interface BillingAddress  {
  /**
 * The city of the billing address.
 */
city: string
...
export namespace CardListParams {export interface CreatedAt  {
  /**
