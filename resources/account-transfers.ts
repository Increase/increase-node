...
export class AccountTransfers extends APIResource {
  ...
  create(body: AccountTransferCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<AccountTransfer>>{
         return this.post('/account_transfers', { body, ...options })
       };

  retrieve(accountTransferId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<AccountTransfer>>{
         return this.get(`/account_transfers/${accountTransferId}`, options)
       };

  list(query?: AccountTransferListParams, options?: Core.RequestOptions): Core.PagePromise<AccountTransfersPage>;
  list(options?: Core.RequestOptions): Core.PagePromise<AccountTransfersPage>;
  list(query: AccountTransferListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<AccountTransfersPage>{
 ...
 */
status: 'pending_submission' | 'pending_approval' | 'canceled' | 'requires_attention' | 'flagged_by_operator' | 'complete'
...
export namespace AccountTransfer {export interface Approval  {
  /**
 * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time at which
...
export namespace AccountTransferListParams {export interface CreatedAt  {
  /**
