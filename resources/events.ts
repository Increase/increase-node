...
export class Events extends APIResource {
  ...
  list(query: EventListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<EventsPage>{
...
export namespace EventListParams {export interface CreatedAt  {
  /**
