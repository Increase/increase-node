...
export class ACHTransfers extends APIResource {
   ...
   */
  createInbound(body: ACHTransferCreateInboundParams, options?: Core.RequestOptions): Promise<Core.APIResponse<ACHTransferSimulation>>{
...
export namespace ACHTransferSimulation {export interface Transaction  {
  /**
 ...
 */
status: 'pending_approval' | 'canceled' | 'pending_submission' | 'submitted' | 'returned' | 'requires_attention' | 'rejected'
...
export namespace ACHTransfer {export interface Approval  {
  /**
 * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time at which
