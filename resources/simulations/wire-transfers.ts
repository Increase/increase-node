...
export class WireTransfers extends APIResource {
   ...
   */
  createInbound(body: WireTransferCreateInboundParams, options?: Core.RequestOptions): Promise<Core.APIResponse<WireTransferSimulation>>{
...
export namespace WireTransferSimulation {export interface Transaction  {
  /**
