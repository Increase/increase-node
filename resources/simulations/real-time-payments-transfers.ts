...
export class RealTimePaymentsTransfers extends APIResource {
   ...
   */
  createInbound(body: RealTimePaymentsTransferCreateInboundParams, options?: Core.RequestOptions): Promise<Core.APIResponse<InboundRealTimePaymentsTransferSimulationResult>>{
...
export namespace InboundRealTimePaymentsTransferSimulationResult {export interface Transaction  {
  /**
