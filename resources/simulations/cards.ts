...
export class Cards extends APIResource {
   ...
   */
  authorize(body: CardAuthorizeParams, options?: Core.RequestOptions): Promise<Core.APIResponse<CardAuthorizationSimulation>>{
   ...
   */
  settlement(body: CardSettlementParams, options?: Core.RequestOptions): Promise<Core.APIResponse<Transaction>>{
...
export namespace CardAuthorizationSimulation {export interface PendingTransaction  {
  /**
...
export namespace PendingTransaction {export interface Source  {
  /**
 ...
 */
category: 'account_transfer_instruction' | 'ach_transfer_instruction' | 'card_authorization' | 'check_deposit_instruction' | 'check_transfer_instruction' | 'card_route_authorization' | 'real_time_payments_transfer_instruction' | 'wire_drawdown_payment_instruction' | 'wire_transfer_instruction' | 'other'
...
export namespace Source {export interface AccountTransferInstruction  {
  /**
...
export namespace DeclinedTransaction {export interface Source  {
  /**
 ...
 * gracefully.
 */
category: 'ach_decline' | 'card_decline' | 'check_decline' | 'inbound_real_time_payments_transfer_decline' | 'international_ach_decline' | 'card_route_decline' | 'other'
...
export namespace Source {export interface ACHDecline  {
  /**
 ...
 */
reason: 'ach_route_canceled' | 'ach_route_disabled' | 'no_ach_route' | 'breaches_limit' | 'credit_entry_refused_by_receiver' | 'group_locked' | 'entity_not_active' | 'insufficient_funds' | 'originator_request'
 ...
 */
reason: 'card_not_active' | 'entity_not_active' | 'group_locked' | 'insufficient_funds' | 'breaches_limit' | 'webhook_declined' | 'webhook_timed_out'
}
 ...
 */
reason: 'ach_route_canceled' | 'ach_route_disabled' | 'breaches_limit' | 'entity_not_active' | 'group_locked' | 'insufficient_funds' | 'unable_to_locate_account' | 'unable_to_process' | 'refer_to_image' | 'stop_payment_requested'
}
 ...
 */
reason: 'account_number_canceled' | 'account_number_disabled' | 'group_locked' | 'entity_not_active' | 'real_time_payments_not_enabled'
