...
export class DeclinedTransactions extends APIResource {
  ...
  retrieve(declinedTransactionId: string, options?: Core.RequestOptions): Promise<Core.APIResponse<DeclinedTransaction>>{
         return this.get(`/declined_transactions/${declinedTransactionId}`, options)
       };

  list(query?: DeclinedTransactionListParams, options?: Core.RequestOptions): Core.PagePromise<DeclinedTransactionsPage>;
  list(options?: Core.RequestOptions): Core.PagePromise<DeclinedTransactionsPage>;
  list(query: DeclinedTransactionListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<DeclinedTransactionsPage>{
...
export namespace DeclinedTransactionListParams {export interface CreatedAt  {
  /**
