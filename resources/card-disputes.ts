...
export class CardDisputes extends APIResource {
  ...
  create(body: CardDisputeCreateParams, options?: Core.RequestOptions): Promise<Core.APIResponse<CardDispute>>{
  ...
  list(query: CardDisputeListParams | Core.RequestOptions = {}, options?: Core.RequestOptions): Core.PagePromise<CardDisputesPage>{
...
export namespace CardDispute {export interface Acceptance  {
  /**
 * The [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) date and time at which
...
export namespace CardDisputeListParams {export interface CreatedAt  {
  /**
