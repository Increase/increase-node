...
Full Changelog: [...abc-v0.0.1](https://github.com/Increase/increase-node/compare/...abc-v0.0.1)
...
* add webhook support for node and python SDKs ([#284](https://github.com/Increase/increase-node/issues/284)) ([7580e13](https://github.com/Increase/increase-node/commit/7580e133b111b6e212c3f89e43b7ce2b3dc78116))
...
* allow installing package directly from github ([#235](https://github.com/Increase/increase-node/issues/235)) ([f6bb5d0](https://github.com/Increase/increase-node/commit/f6bb5d04c17fa3d0a2bf6903f361ae108e4654f6))
...
* **api:** add `ach_debit_status` ([#265](https://github.com/Increase/increase-node/issues/265)) ([cea94b6](https://github.com/Increase/increase-node/commit/cea94b678f32326ac7e2dd51990dba818c90cee1))
...
* **api:** add `suspected_fraud` rejection reason ([#247](https://github.com/Increase/increase-node/issues/247)) ([e1110ad](https://github.com/Increase/increase-node/commit/e1110ad1657c346e74a27718e4f4ca4a7b4e047d))
* **api:** add addenda details for ACH transfers ([#202](https://github.com/Increase/increase-node/issues/202)) ([6f5d83f](https://github.com/Increase/increase-node/commit/6f5d83fc5f654ff717dcab98b806c408579a8fe9))
* **api:** add bank_of_first_deposit_routing_number and transfer_id properties ([#142](https://github.com/Increase/increase-node/issues/142)) ([6eb013a](https://github.com/Increase/increase-node/commit/6eb013add0d889478163f04203885eab1267be17))
* **api:** add card payment ID reference to transaction models ([#158](https://github.com/Increase/increase-node/issues/158)) ([ec11a06](https://github.com/Increase/increase-node/commit/ec11a0667ca934e92092b58eb1623086c78cf97d))
* **api:** add card payments endpoints ([#178](https://github.com/Increase/increase-node/issues/178)) ([0102084](https://github.com/Increase/increase-node/commit/01020848b9c53f6885a2af8e7bab24fecaf9eafd))
...
* **api:** add deposit_submission property to check deposit ([#253](https://github.com/Increase/increase-node/issues/253)) ([f898e8c](https://github.com/Increase/increase-node/commit/f898e8c27ce0c715962fa5d0734b56a20775c92e))
* **api:** add direction property to CardAuthorization ([#185](https://github.com/Increase/increase-node/issues/185)) ([7108cef](https://github.com/Increase/increase-node/commit/7108cef2c454144adaaeba3c1980eae60e8a8668))
* **api:** add entity_id to Card and make relationship nullable ([#165](https://github.com/Increase/increase-node/issues/165)) ([f74b66a](https://github.com/Increase/increase-node/commit/f74b66aaa3891901d897238b1159114a4994a1ae))
* **api:** add failed to export status enum ([#224](https://github.com/Increase/increase-node/issues/224)) ([624f6aa](https://github.com/Increase/increase-node/commit/624f6aa6e6c411af328156296246db66733758ed))
...
* **api:** add fuel confirmation functionality ([#211](https://github.com/Increase/increase-node/issues/211)) ([6657b5c](https://github.com/Increase/increase-node/commit/6657b5cbee1e620afc95e1e1934b352fc6b4fb63))
* **api:** add inbound checks, originating routing number and new event types ([#173](https://github.com/Increase/increase-node/issues/173)) ([a809cc8](https://github.com/Increase/increase-node/commit/a809cc8d446e064f198f3702d3699b05d0969a96))
* **api:** add merchant data to simulation api ([#273](https://github.com/Increase/increase-node/issues/273)) ([448c879](https://github.com/Increase/increase-node/commit/448c879fc9a5cc8d62ac05620393a562bfae9121))
* **api:** add network identifiers and effective date ([#219](https://github.com/Increase/increase-node/issues/219)) ([69da5df](https://github.com/Increase/increase-node/commit/69da5df3efa862b09ada60d0509194f44a2763a5))
...
* **api:** add oauth token and inbound wire transfer methods ([#287](https://github.com/Increase/increase-node/issues/287)) ([314a14d](https://github.com/Increase/increase-node/commit/314a14dfcd8c68f52d59e98fce4518677203d80e))
...
* **api:** add physical cards endpoints ([#176](https://github.com/Increase/increase-node/issues/176)) ([5efe93f](https://github.com/Increase/increase-node/commit/5efe93fa3ef991b3a76f4b4c549ec9c1f419fa80))
...
* **api:** add real-time payments request for payment endpoints ([#260](https://github.com/Increase/increase-node/issues/260)) ([94b4e5b](https://github.com/Increase/increase-node/commit/94b4e5b4597dabbb80ca3c128e6da13a00fa10e2))
* **api:** add returned_per_odfi_request enum ([#210](https://github.com/Increase/increase-node/issues/210)) ([bc28036](https://github.com/Increase/increase-node/commit/bc280364656b3b17c261d16cf6d833afd2b1c799))
...
* **api:** add Update Address  and Create Notification Change endpoints ([#149](https://github.com/Increase/increase-node/issues/149)) ([cec96dd](https://github.com/Increase/increase-node/commit/cec96dd6bdd4382ed1f1612bf37ac8fc362fe633))
...
* **api:** expand event categories and Entity status options ([#183](https://github.com/Increase/increase-node/issues/183)) ([462033a](https://github.com/Increase/increase-node/commit/462033acbe5dc49026f23af52a6c9705cdaa79c7))
* **api:** export account statements in OFX format ([#169](https://github.com/Increase/increase-node/issues/169)) ([740fd02](https://github.com/Increase/increase-node/commit/740fd02814a9d9d038470c53a7c802474645f807))
* **api:** list Inbound Wire Transfers, change transfer simulation return types ([#292](https://github.com/Increase/increase-node/issues/292)) ([37894ea](https://github.com/Increase/increase-node/commit/37894eae196becab0889128e60633e53b0ebd704))
...
* **api:** remove Limits API, add ACH controls to Account Numbers   ([#156](https://github.com/Increase/increase-node/issues/156)) ([d83c143](https://github.com/Increase/increase-node/commit/d83c143b0d9538943aa28db7622713fb53e98f32))
* **api:** remove unused `/inbound_ach_transfer_returns` endpoints ([#141](https://github.com/Increase/increase-node/issues/141)) ([335aeca](https://github.com/Increase/increase-node/commit/335aecab5205d64d03d1cd866372c4a55b307d6e))
...
* **api:** restructure balance lookups ([#231](https://github.com/Increase/increase-node/issues/231)) ([16b67d9](https://github.com/Increase/increase-node/commit/16b67d9df5dbc9c805f94b0c7670e7bc827afcf0))
* **api:** simplify WireDecline and InboundWireTransfer ([#288](https://github.com/Increase/increase-node/issues/288)) ([2216229](https://github.com/Increase/increase-node/commit/22162299db01d1269ed2dd41758af2a7a038bff5))
* **api:** split card profile resource into digital and physical card profile resources ([#303](https://github.com/Increase/increase-node/issues/303)) ([c5e57ea](https://github.com/Increase/increase-node/commit/c5e57eab696f07be59b9c0a7616d1822b9c87d9e))
* **api:** update descriptions ([#293](https://github.com/Increase/increase-node/issues/293)) ([bb67f9a](https://github.com/Increase/increase-node/commit/bb67f9a44085368379357f53e522aedd6579b84a))
...
* **api:** updates ([#204](https://github.com/Increase/increase-node/issues/204)) ([6ea3f20](https://github.com/Increase/increase-node/commit/6ea3f20dac016be89bc64e50575c0b0085a320b5))
* **api:** updates ([#208](https://github.com/Increase/increase-node/issues/208)) ([4671d5c](https://github.com/Increase/increase-node/commit/4671d5c012e076ce164e688d2f8b77b4002efee2))
* **api:** updates ([#209](https://github.com/Increase/increase-node/issues/209)) ([6a716bf](https://github.com/Increase/increase-node/commit/6a716bfabc494b6b76eb4777826fdcf9c4867ec1))
* **api:** updates ([#217](https://github.com/Increase/increase-node/issues/217)) ([b9576c5](https://github.com/Increase/increase-node/commit/b9576c596287179884ec9c4707842365ac5dba06))
* **api:** updates ([#244](https://github.com/Increase/increase-node/issues/244)) ([dfd2aaf](https://github.com/Increase/increase-node/commit/dfd2aafac91ec3222599421fa51ec9ab8eea358f))
...
* **client:** adjust retry behavior to be exponential backoff ([#212](https://github.com/Increase/increase-node/issues/212)) ([e9ff283](https://github.com/Increase/increase-node/commit/e9ff283d3ce7d1d02c64943c0cb4be0c8d9a43c4))
* **client:** allow binary returns ([#225](https://github.com/Increase/increase-node/issues/225)) ([587bf21](https://github.com/Increase/increase-node/commit/587bf2142d7ba507d1ec8ecfcb2516c5e5c190c8))
...
* **client:** handle retry-after with a date ([#175](https://github.com/Increase/increase-node/issues/175)) ([5f3ee0a](https://github.com/Increase/increase-node/commit/5f3ee0ab71e78223a3917b305515b625f0630e1e))
...
* **client:** retry on 408 Request Timeout ([#160](https://github.com/Increase/increase-node/issues/160)) ([56b9b3a](https://github.com/Increase/increase-node/commit/56b9b3a0d8f00f695758efd5bb8f5ce1e27915a7))
...
* **client:** support importing node or web shims manually ([#168](https://github.com/Increase/increase-node/issues/168)) ([fbdfa75](https://github.com/Increase/increase-node/commit/fbdfa7557b6fc7078de41fcabb073ec3f8fc4763))
...
* **client:** support reading the base url from an env variable ([#240](https://github.com/Increase/increase-node/issues/240)) ([76fddf1](https://github.com/Increase/increase-node/commit/76fddf15e30c8000f45ff380360c0d9b46e98994))
...
* **errors:** add status code to error message ([#164](https://github.com/Increase/increase-node/issues/164)) ([4e6e395](https://github.com/Increase/increase-node/commit/4e6e39577c0398eb84958fdf3aa6f012fe336d35))
* fixes tests where an array has to have unique enum values ([#150](https://github.com/Increase/increase-node/issues/150)) ([ddc19a7](https://github.com/Increase/increase-node/commit/ddc19a71849395ab45bf19ae658f48ab3aaca8a5))
* **github:** include a devcontainer setup ([#223](https://github.com/Increase/increase-node/issues/223)) ([caefbdf](https://github.com/Increase/increase-node/commit/caefbdf94b34f6d507e0ad85552912719b74c4d1))
* handle 204 No Content gracefully ([#207](https://github.com/Increase/increase-node/issues/207)) ([2e0bc6d](https://github.com/Increase/increase-node/commit/2e0bc6d9da931321896080f57b09213b93baca95))
* **package:** add Bun export map ([#144](https://github.com/Increase/increase-node/issues/144)) ([d3efdd0](https://github.com/Increase/increase-node/commit/d3efdd08260f91b92b17c0cf715b21ed9eebd7cb))
* **package:** export a root error type ([#174](https://github.com/Increase/increase-node/issues/174)) ([136c97e](https://github.com/Increase/increase-node/commit/136c97e76798692e40894da37c2bbda42227c1c6))
...
* allow body type in RequestOptions to be null ([#282](https://github.com/Increase/increase-node/issues/282)) ([b7eb6e5](https://github.com/Increase/increase-node/commit/b7eb6e5e1ace97d215e1f36c379b595b08302017))
* **api:** move ACH Return endpoint and add digital wallet properties ([#139](https://github.com/Increase/increase-node/issues/139)) ([c385d49](https://github.com/Increase/increase-node/commit/c385d49693729f5056313923fa6f83ea8dd1a288))
* **ci:** ignore stainless-app edits to release PR title ([#280](https://github.com/Increase/increase-node/issues/280)) ([4780b93](https://github.com/Increase/increase-node/commit/4780b9348fdf4e07b7977c96bc77ff16cce7ea3d))
...
* **client:** fix TS errors that appear when users Go to Source in VSCode ([#147](https://github.com/Increase/increase-node/issues/147)) ([3ca7e5a](https://github.com/Increase/increase-node/commit/3ca7e5a47ec6cff0e96570a525ad9b0c0e8314ba))
...
* **client:** handle case where the client is instantiated with a undefined baseURL ([#148](https://github.com/Increase/increase-node/issues/148)) ([a5cd2cf](https://github.com/Increase/increase-node/commit/a5cd2cf442280c0c89b77ae12a2e21a1a6b53b18))
...
* **client:** use explicit file extensions in _shims imports ([#146](https://github.com/Increase/increase-node/issues/146)) ([d1bd09c](https://github.com/Increase/increase-node/commit/d1bd09caf6e1d6424e20c5c31aa962d9aef784ef))
...
* fix module not found errors in Vercel edge ([#155](https://github.com/Increase/increase-node/issues/155)) ([c695096](https://github.com/Increase/increase-node/commit/c695096212e6e67efaad986b71451db3cd86a628))
* fix namespace exports regression ([#192](https://github.com/Increase/increase-node/issues/192)) ([fcee38c](https://github.com/Increase/increase-node/commit/fcee38c78c502648c7012076e3d77b7c624eb0ae))
...
* **headers:** always send lowercase headers and strip undefined (BREAKING in rare cases) ([#261](https://github.com/Increase/increase-node/issues/261)) ([5dae025](https://github.com/Increase/increase-node/commit/5dae0253298056b9879331d62360f76fed7c4a40))
...
* import web-streams-polyfill without overriding globals ([#203](https://github.com/Increase/increase-node/issues/203)) ([da172c8](https://github.com/Increase/increase-node/commit/da172c87f62d230764c6b65ca098aa36501255c4))
* improve status code in error messages ([#200](https://github.com/Increase/increase-node/issues/200)) ([61c61b6](https://github.com/Increase/increase-node/commit/61c61b63ab09494e90537c6afdb18d965da15ed3))
...
* prevent ReferenceError, update compatibility to ES2020 and Node 18+ ([#187](https://github.com/Increase/increase-node/issues/187)) ([0e69575](https://github.com/Increase/increase-node/commit/0e695754e07829e64fa593018174b33f8657a0d6))
* **readme:** update link to api.md to use the correct branch ([#152](https://github.com/Increase/increase-node/issues/152)) ([813be11](https://github.com/Increase/increase-node/commit/813be11e0729c36551664ab038421d17dc4355d4))
...
* **types:** accept undefined for optional client options ([#279](https://github.com/Increase/increase-node/issues/279)) ([4694c9f](https://github.com/Increase/increase-node/commit/4694c9f585efc3d32aa1203ddb6239363345368f))
* **types:** improve getNextPage() return type ([#140](https://github.com/Increase/increase-node/issues/140)) ([6422a13](https://github.com/Increase/increase-node/commit/6422a136b2627226146707f2a237a2b895ab2702))
* typo in build script ([#215](https://github.com/Increase/increase-node/issues/215)) ([1fe5570](https://github.com/Increase/increase-node/commit/1fe5570e9ac14a788d9e7d0b6501dd918970b332))
* use default base url if BASE_URL env var is blank ([#269](https://github.com/Increase/increase-node/issues/269)) ([d432f39](https://github.com/Increase/increase-node/commit/d432f39536f26dd6f1cfdd42c18344534261c94e))
...
* fix oauth casing ([#286](https://github.com/Increase/increase-node/issues/286)) ([a766c4d](https://github.com/Increase/increase-node/commit/a766c4d8da9c4a3029a1f60d482504b159a09fc6))
