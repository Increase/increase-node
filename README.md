...
The full API of this library can be found in [api.md](https://www.github.com/increase/increase-node/blob/main/api.md).
...
This can also be useful if you are getting the wrong TypeScript types for `Response` - more details [here](https://github.com/increase/increase-node/tree/main/src/_shims#readme).
