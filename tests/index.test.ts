...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    test('debug logs when log level is debug', async () => {
      ...
      const client = new Increase({ logger: logger, logLevel: 'debug', apiKey: 'My API Key' });
    ...
    test('debug logs are skipped when log level is info', async () => {
      ...
      const client = new Increase({ logger: logger, logLevel: 'info', apiKey: 'My API Key' });
    ...
    test('client log level overrides env var', async () => {
      ...
      process.env['INCREASE_LOG'] = 'debug';
      const client = new Increase({ logger: logger, logLevel: 'off', apiKey: 'My API Key' });
  ...
  describe('withOptions', () => {
    test('creates a new client with overridden options', async () => {
      const client = new Increase({ baseURL: 'http://localhost:5000/', maxRetries: 3, apiKey: 'My API Key' });
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Increase({ baseURL: 'http://localhost:5000/', timeout: 1000, apiKey: 'My API Key' });
...
describe('retries', () => {
  ...
  test('retry count header', async () => {
    ...
    const client = new Increase({ apiKey: 'My API Key', fetch: testFetch, maxRetries: 4 });
