...
describe('resource realTimePaymentsRequestForPayments', () => {
  test('create: only required params', async () => {
    const responsePromise = client.realTimePaymentsRequestForPayments.create({
      amount: 100,
  ...
  test('retrieve', async () => {
    const responsePromise = client.realTimePaymentsRequestForPayments.retrieve(
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.realTimePaymentsRequestForPayments.retrieve('real_time_payments_transfer_iyuhl5kdn7ssmup83mvq', {
  ...
  test('list', async () => {
    const responsePromise = client.realTimePaymentsRequestForPayments.list();
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test('list: request options instead of params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.realTimePaymentsRequestForPayments.list({ path: '/_stainless_unknown_path' }),
    ).rejects.toThrow(Increase.NotFoundError);
  });
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.realTimePaymentsRequestForPayments.list(
        {
